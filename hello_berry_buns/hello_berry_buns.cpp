...
int main() {
  cout << "50g of butter dissolve not entirely\n";
  cout << "Add 3 spoons of sugar\n";
  cout << "Add 15g of yeast\n";
  cout << "Leave to rest for 15 min\n";
  cout << "Whip with fork 1 egg and bigger part of dissolved butter\n";
  ...
  cout << "Moisture with dissolved butter and 1 spoon of sugar\n";
  ...
  cout << "Bake in owen heaten up to 180 C\n";
  keep_window_open();
  return 0;
}
